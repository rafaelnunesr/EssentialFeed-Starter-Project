...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        guard let receivedError = error as? NSError else {
            XCTFail("Expected NSError, got \(error) instead.")
            return
        }
    ...
    private func resultErrorFor(data: Data?, response: URLResponse?,
                                error: Error?, file: StaticString = #filePath, line: UInt = #line) -> Error? {
        let result = resultFor(data: data, response: response, error: error, file: file, line: line)
    ...
    private func resultFor(data: Data?, response: URLResponse?, error: Error?, file: StaticString = #filePath, line: UInt = #line) -> HTTPClientResult {
        ...
        let exp = expectation(description: "Wait for request error")
