...
//  EssentialFeed
//
//  Created by Rafael Rios on 28/03/25.
//
...
class LocalFeedImageDataLoaderTests: XCTestCase {
    ...
    func test_loadImageDataFromURL_deliversNoFoundErrorOnNotFound() {
        let (sut, store) = makeSUT()
    ...
    func test_saveImageDataFroURL_requestsImageDataInsertionForURL() {
        let (sut, store) = makeSUT()
        let url = anyURL()
        let data = anyData()
